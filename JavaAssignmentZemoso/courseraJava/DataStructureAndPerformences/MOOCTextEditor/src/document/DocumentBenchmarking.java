...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			doc.getFleschScore();
			long basicStop = System.nanoTime();
			long basicEstimate = (basicStop-basicStart);

			long effStart = System.nanoTime();
			effDoc.getFleschScore();
			long effStop = System.nanoTime();
			long effEstimate = (effStop-effStart);

			System.out.print(basicEstimate + "\t" + effEstimate + "\n");			 
		}
